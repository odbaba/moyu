...
const magicStoneMerchantItems: ShopItem[] = [
  // 幻兽类
  {
    ...
    icon: '🐾',
    imagePath: './images/pet/gongfangxing.jpg',
    stackable: false,
    maxStack: 1,
  },
  {
    ...
    icon: '🐱',
    imagePath: './images/pet/tiaopimao.jpg',
    stackable: false,
    maxStack: 1,
  },
  {
    ...
    icon: '🐷',
    imagePath: './images/pet/jiluzhu.jpg',
    stackable: false,
    maxStack: 1,
  },
  {
    ...
    icon: '🦄',
    imagePath: './images/pet/qiyishou.jpg',
    stackable: false,
    maxStack: 1,
  },
  {
    ...
    icon: '🛡️',
    imagePath: './images/pet/shouhu.jpg',
    stackable: false,
    maxStack: 1,
  },
  {
