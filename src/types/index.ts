...
// 物品类型枚举
export type ItemType = 'consumable' | 'material' | 'equipment' | 'quest' | 'other' | 'skillBook' | 'gem' | 'special';
 ...
 * 定义选项显示的条件类型
 */
export type NPCConditionType = 'weekday' | 'relationship' | 'militaryRank' | 'nobleRank' | 'custom';
